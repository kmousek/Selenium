package com.kmousek.springboot.reserveCourt.DAO;
...
//	ArrayList<ReserveInfoDao> reserveInfos = new ArrayList<>();
	...
	private YangjaeDao() {
		...
		courtNum.put("2_A","4344685");
		courtNum.put("2_B","4344686");
		courtNum.put("2_C","4344688");
		courtNum.put("2_1","4344689");
		courtNum.put("2_2","4344690");
		courtNum.put("2_3","4344692");
		courtNum.put("2_4","4344693");
		courtNum.put("2_5","4344694");
		courtNum.put("2_6","4344695");
		courtNum.put("2_7","4344696");
		courtNum.put("2_8","4344697");
	...
	public static boolean chkHoliday(int[] dateInt) {
		...
		int dayOfWeekNumber = cal.get(Calendar.DAY_OF_WEEK);  //1:�Ͽ���, 7:�����		
